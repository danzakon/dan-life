...
- 20260307-ID-009 (software factories) — factories need this infrastructure
- 20260307-ID-002 (mobile agent UI) — the UI layer sits on top of this stack
- 20260307-ID-005 (agent lifespan) — infrastructure determines agent lifecycle options
